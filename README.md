# Modern GUI — OpenPeon Sound Pack

A futuristic synth UI sound pack built from [Tissman's Modern GUI](https://freesound.org/people/Tissman/packs/29401/) on Freesound.

## Sound style

Cyberpunk-flavoured hightech tones — clean confirms, glitchy error buzzes, warning sweeps, and popup transitions. 28 sounds curated from 79 originals.
...
Original sounds by [Tissman](https://freesound.org/people/Tissman/) on Freesound.
